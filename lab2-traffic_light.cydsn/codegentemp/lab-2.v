// ======================================================================
// lab-2.v generated from TopDesign.cysch
// 11/04/2022 at 13:43
...
module top ;
    ...
    TCPWM_P4_v2_10_0 Timer_Counter (
        .capture(1'b0),
        .cc(Net_9),
        .clock(Net_12),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("d0d17e52-0538-4ab1-807c-74e05fff1844"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("faf915be-25cc-450a-9e96-1a9180888522"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ed33690e-6f14-4cb4-838f-c3cb5ce56e81"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
